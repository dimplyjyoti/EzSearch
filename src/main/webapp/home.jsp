            ...
            <div class="mbr-navbar__container">
                <div class="mbr-navbar__column mbr-navbar__column--s mbr-navbar__brand">
                    <span class="mbr-navbar__brand-link mbr-brand mbr-brand--inline">
                        <span class="mbr-brand__logo"><img class="mbr-navbar__brand-img mbr-brand__img" src="assets/images/search-862x744-69.png"></span>
                        <span class="mbr-brand__name"><a class="mbr-brand__name text-danger" href="home.jsp">EzSearch<br></a></span>
                    </span>
                </div>
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size mbr-after-navbar" id="form1-3" style="background-color: rgb(209, 164, 255);">
